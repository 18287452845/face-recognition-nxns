        ...
        prompt = `Please analyze this face photo and return the following information in JSON format. The evaluation content should only contain positive and praising content, and be detailed and specific.
{
  ...
  "temperament": "Intellectual/Elegant/Vibrant/Gentle/Sophisticated/Sweet/Sunny/Artistic",
  "skinTone": "Fair/Tan/Natural",
        ...
        prompt = `请分析这张人脸照片，以JSON格式返回以下信息。评价内容请只包含正面和赞美的内容，要详细具体：
{
  ...
  "faceShape": "圆脸/方脸/长脸/椭圆脸/心形脸",
  "temperament": "知性/优雅/活泼/温和/冷艳/甜美/阳光/文艺",
  "skinTone": "白皙/健康小麦色/自然肤色",
  "beautyScore": 1-100的数字,
  "evaluation": "2-3句详细的正面评价和赞美，包括气质、气色、整体印象等各方面（如：眼神灵动深邃，散发知性气质，五官精致立体，气场高贵优雅，整体形象出众迷人）",
